...
if __name__ == '__main__':
    ...
    reachability_space_with_obstacles = create_reachability_space_from_obstacles(obstacles_dir, obstacles_list,
                                                                                 mins[:3], step_size[:3], dims[:3])
    ...
    reachability_space = combine_reachability_space_with_obstacles_space(reachability_space,
                                                                         reachability_space_with_obstacles)
    # visualize new reachability space
    reachability_space_points = parse_reachability_space_to_point_list(reachability_space, mins, step_size, dims)
    display_reachability_space_data(reachability_space_points, marker_topic="marker_topic", frame_id="object_0")
